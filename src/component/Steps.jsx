...
const Steps = () => {
  return (
    <div>
      ...
      <div className='flex gap-8 justify-center p-8 bg-white'>
        <div className='text-left m-7 w-[70%] '>
        ...
        <div className='w-[30%] text-left m-7 p-8 '>
          <div className='text-lg text-[#757580] font-bold text-center'>
            HAVE A QUETIONS?
          </div>
